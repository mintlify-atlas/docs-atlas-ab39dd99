...
<Note>
  Data retention and purging features are planned for a future release.
</Note>

Future capabilities will include:

- **Automatic Purging** - Delete archived clusters after a configured retention period
- **Retention Policies** - Set different retention periods for different data types
- **PII Masking** - Automatically redact sensitive fields before AI processing
